...
class OutlineClient(BaseOutlineClient):
    """
    Outline API client.
    ...
    def __init__(
        ...
        """
        Create a new client for the Outline API.
    ...
    def _run[T](self, operation: Operation[T]) -> T:
        ...
        """
        return operation.parse(self.request(operation.path, operation.payload))

    # -------------------------------------------------------------------------
    # METHOD: _download
    # -------------------------------------------------------------------------

    def _download(self, path: str, payload: dict[str, Any], accept: str) -> bytes:
        """
    ...
    def paginate[T](
        ...
        **kwargs: Any,
        ...
        Returns:
            Iterator[T]: Every record, in the order the API returned them.
        """
        offset = 0
        while True:
            page = method(offset=offset, limit=limit, **kwargs)
            yield from page
    ...
    def get_auth_info(self) -> Auth:
        ...
        """
        return self._run(auth_ops.get_auth_info())
    ...
    def get_auth_config(self) -> AuthConfig:
        ...
        """
        return self._run(auth_ops.get_auth_config())
    ...
    def sign_out(self) -> bool:
        ...
        """
        return self._run(auth_ops.sign_out())
    ...
    def get_user(self, id: str) -> User:
        ...
        Returns:
            User: The user.
        """
        return self._run(user_ops.get_user(id))
    ...
    def invite_users(
        ...
        *,
        ...
        """
        return self._run(user_ops.invite_users(invites, suppress_email=suppress_email))

    # -------------------------------------------------------------------------
    # METHOD: resend_invite
    # -------------------------------------------------------------------------

    def resend_invite(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(user_ops.resend_invite(id))
    ...
    def update_user_email(self, email: str, *, id: str | None = None) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(user_ops.update_user_email(email, id=id))

    # -------------------------------------------------------------------------
    # METHOD: update_user_role
    # -------------------------------------------------------------------------

    def update_user_role(self, id: str, role: UserRole | str) -> User:
        """
        ...
        Returns:
            User: The updated user.
        """
        return self._run(user_ops.update_user_role(id, role))

    # -------------------------------------------------------------------------
    # METHOD: suspend_user
    # -------------------------------------------------------------------------

    def suspend_user(self, id: str) -> User:
        """
        ...
        """
        return self._run(user_ops.suspend_user(id))
    ...
    def activate_user(self, id: str) -> User:
        ...
        """
        return self._run(user_ops.activate_user(id))
    ...
    def delete_user(self, id: str) -> bool:
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(user_ops.delete_user(id))

    # -------------------------------------------------------------------------
    # METHOD: subscribe_to_notifications
    # -------------------------------------------------------------------------

    def subscribe_to_notifications(self, event_type: str) -> User:
        """
        ...
        """
        return self._run(user_ops.subscribe_to_notifications(event_type))

    # -------------------------------------------------------------------------
    # METHOD: unsubscribe_from_notifications
    # -------------------------------------------------------------------------

    def unsubscribe_from_notifications(self, event_type: str) -> User:
        """
        ...
        Returns:
            User: The updated user, with the new notification settings.
        """
        return self._run(user_ops.unsubscribe_from_notifications(event_type))
        ...
        *,
        ...
        Returns:
            UserMembershipsResult: The memberships and the documents they
                refer to.
        """
        return self._run(user_ops.list_user_memberships(offset=offset, limit=limit))

    # -------------------------------------------------------------------------
    # METHOD: update_user_membership
    # -------------------------------------------------------------------------

    def update_user_membership(self, id: str, index: str) -> Membership:
        """
        ...
        """
        return self._run(user_ops.update_user_membership(id, index))
    ...
    def get_group(self, id: str) -> Group:
        ...
        Returns:
            Group: The group.
        """
        return self._run(group_ops.get_group(id))
    ...
    def create_group(self, name: str) -> Group:
        ...
        """
        return self._run(group_ops.create_group(name))

    # -------------------------------------------------------------------------
    # METHOD: update_group
    # -------------------------------------------------------------------------

    def update_group(self, id: str, name: str) -> Group:
        """
        Rename a group.
        ...
        """
        return self._run(group_ops.update_group(id, name))
    ...
    def delete_group(self, id: str) -> bool:
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(group_ops.delete_group(id))
    ...
    def add_group_user(self, id: str, user_id: str) -> GroupMembershipsResult:
        """
        ...
        """
        return self._run(group_ops.add_group_user(id, user_id))
    ...
    def update_group_user(
        ...
        Returns:
            GroupMembershipsResult: The group, the user, and the updated
                membership.
        """
        return self._run(group_ops.update_group_user(id, user_id, permission))

    # -------------------------------------------------------------------------
    # METHOD: remove_group_user
    # -------------------------------------------------------------------------

    def remove_group_user(self, id: str, user_id: str) -> GroupMembershipsResult:
        """
        ...
        """
        return self._run(group_ops.remove_group_user(id, user_id))
    ...
    def get_collection(self, id: str) -> Collection:
        ...
        """
        return self._run(collection_ops.get_collection(id))

    # -------------------------------------------------------------------------
    # METHOD: get_collection_structure
    # -------------------------------------------------------------------------

    def get_collection_structure(self, id: str) -> list[NavigationNode]:
        """
        ...
        """
        return self._run(collection_ops.get_collection_structure(id))
    ...
    def delete_collection(self, id: str) -> bool:
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(collection_ops.delete_collection(id))

    # -------------------------------------------------------------------------
    # METHOD: duplicate_collection
    # -------------------------------------------------------------------------

    def duplicate_collection(self, id: str, *, name: str | None = None) -> Collection:
        """
        ...
        """
        return self._run(collection_ops.duplicate_collection(id, name=name))

    # -------------------------------------------------------------------------
    # METHOD: archive_collection
    # -------------------------------------------------------------------------

    def archive_collection(self, id: str) -> Collection:
        """
        ...
        """
        return self._run(collection_ops.archive_collection(id))

    # -------------------------------------------------------------------------
    # METHOD: restore_collection
    # -------------------------------------------------------------------------

    def restore_collection(self, id: str) -> Collection:
        """
        ...
        """
        return self._run(collection_ops.restore_collection(id))

    # -------------------------------------------------------------------------
    # METHOD: move_collection
    # -------------------------------------------------------------------------

    def move_collection(self, id: str, index: str) -> CollectionIndex:
        """
        ...
        """
        return self._run(collection_ops.move_collection(id, index))
    ...
    def remove_collection_user(self, id: str, user_id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(collection_ops.remove_collection_user(id, user_id))
    ...
    def remove_collection_group(self, id: str, group_id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(collection_ops.remove_collection_group(id, group_id))
    ...
    def export_collection(
        ...
        *,
        ...
        """
        return self._run(collection_ops.export_collection(id, format=format))
    ...
    def get_document(
        ...
        *,
        ...
        """
        return self._run(document_ops.get_document(id, share_id=share_id))

    # -------------------------------------------------------------------------
    # METHOD: get_document_structure
    # -------------------------------------------------------------------------

    def get_document_structure(self, id: str) -> NavigationNode:
        """
        ...
        """
        return self._run(document_ops.get_document_structure(id))
    ...
    def delete_document(self, id: str, *, permanent: bool | None = None) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(document_ops.delete_document(id, permanent=permanent))
    ...
    def archive_document(self, id: str) -> Document:
        """
        ...
        """
        return self._run(document_ops.archive_document(id))
    ...
    def unpublish_document(self, id: str, *, detach: bool | None = None) -> Document:
        """
        ...
        """
        return self._run(document_ops.unpublish_document(id, detach=detach))
    ...
    def empty_trash(self) -> bool:
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(document_ops.empty_trash())
    ...
    def download_document(
        ...
        *,
        ...
        return self._download(operation.path, operation.payload, accept)
    ...
    def remove_document_user(self, id: str, user_id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(document_ops.remove_document_user(id, user_id))
    ...
    def remove_document_group(self, id: str, group_id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(document_ops.remove_document_group(id, group_id))
    ...
    def get_template(self, id: str) -> Template:
        ...
        """
        return self._run(template_ops.get_template(id))
    ...
    def restore_template(self, id: str) -> Template:
        """
        ...
        """
        return self._run(template_ops.restore_template(id))
    ...
    def delete_template(self, id: str) -> bool:
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(template_ops.delete_template(id))
    ...
    def delete_comment(self, id: str) -> bool:
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(comment_ops.delete_comment(id))

    # -------------------------------------------------------------------------
    # METHOD: resolve_comment
    # -------------------------------------------------------------------------

    def resolve_comment(self, id: str) -> Comment:
        """
        ...
        """
        return self._run(comment_ops.resolve_comment(id))

    # -------------------------------------------------------------------------
    # METHOD: unresolve_comment
    # -------------------------------------------------------------------------

    def unresolve_comment(self, id: str) -> Comment:
        """
        ...
        """
        return self._run(comment_ops.unresolve_comment(id))

    # -------------------------------------------------------------------------
    # METHOD: add_comment_reaction
    # -------------------------------------------------------------------------

    def add_comment_reaction(self, id: str, emoji: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(comment_ops.add_comment_reaction(id, emoji))

    # -------------------------------------------------------------------------
    # METHOD: remove_comment_reaction
    # -------------------------------------------------------------------------

    def remove_comment_reaction(self, id: str, emoji: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(comment_ops.remove_comment_reaction(id, emoji))
    ...
    def get_revision(self, id: str) -> RevisionDetail:
        """
        ...
        """
        return self._run(revision_ops.get_revision(id))

    # -------------------------------------------------------------------------
    # METHOD: update_revision
    # -------------------------------------------------------------------------

    def update_revision(self, id: str, name: str) -> Revision:
        """
        ...
        """
        return self._run(revision_ops.update_revision(id, name))

    # -------------------------------------------------------------------------
    # METHOD: delete_revision
    # -------------------------------------------------------------------------

    def delete_revision(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(revision_ops.delete_revision(id))

    # -------------------------------------------------------------------------
    # METHOD: export_revision
    # -------------------------------------------------------------------------

    def export_revision(self, id: str) -> FileOperationResult:
        """
        ...
        Returns:
            FileOperationResult: The queued export.
        """
        return self._run(revision_ops.export_revision(id))
    ...
    def get_share(
        ...
        *,
        ...
        Returns:
            Share: The share.
        """
        return self._run(share_ops.get_share(id, document_id=document_id))
    ...
    def revoke_share(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(share_ops.revoke_share(id))
    ...
    def list_stars(
        ...
        *,
        ...
        """
        return self._run(star_ops.list_stars(offset=offset, limit=limit))
    ...
    def update_star(self, id: str, index: str) -> Star:
        """
        ...
        """
        return self._run(star_ops.update_star(id, index))

    # -------------------------------------------------------------------------
    # METHOD: delete_star
    # -------------------------------------------------------------------------

    def delete_star(self, id: str) -> bool:
        """
        Remove a star.
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(star_ops.delete_star(id))
    ...
    def get_pin(self, document_id: str, *, collection_id: str | None = None) -> Pin:
        """
        ...
        Returns:
            Pin: The pin.
        """
        return self._run(pin_ops.get_pin(document_id, collection_id=collection_id))
    ...
    def update_pin(self, id: str, index: str) -> Pin:
        """
        Reorder a pin.
        ...
        Returns:
            Pin: The updated pin.
        """
        return self._run(pin_ops.update_pin(id, index))
    ...
    def delete_pin(self, id: str) -> bool:
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(pin_ops.delete_pin(id))
    ...
    def delete_subscription(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(subscription_ops.delete_subscription(id))
    ...
    def delete_attachment(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(attachment_ops.delete_attachment(id))

    # -------------------------------------------------------------------------
    # METHOD: get_attachment_url
    # -------------------------------------------------------------------------

    def get_attachment_url(self, id: str) -> str:
        """
    ...
    def download_attachment(self, id: str) -> bytes:
        """
    ...
    def get_file_operation(self, id: str) -> FileOperation:
        """
        ...
        """
        return self._run(file_operation_ops.get_file_operation(id))

    # -------------------------------------------------------------------------
    # METHOD: download_file_operation
    # -------------------------------------------------------------------------

    def download_file_operation(self, id: str) -> bytes:
        """
    ...
    def delete_file_operation(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(file_operation_ops.delete_file_operation(id))
    ...
    def get_data_attribute(self, id: str) -> DataAttribute:
        """
        ...
        """
        return self._run(data_attribute_ops.get_data_attribute(id))
    ...
    def delete_data_attribute(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(data_attribute_ops.delete_data_attribute(id))
    ...
    def create_access_request(self, document_id: str) -> AccessRequest:
        """
        ...
        """
        return self._run(access_request_ops.create_access_request(document_id))
    ...
    def dismiss_access_request(self, id: str) -> AccessRequest:
        """
        ...
        """
        return self._run(access_request_ops.dismiss_access_request(id))
    ...
    def delete_api_key(self, id: str) -> bool:
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(api_key_ops.delete_api_key(id))
    ...
    def list_oauth_clients(
        ...
        *,
        ...
        """
        return self._run(oauth_ops.list_oauth_clients(offset=offset, limit=limit))
    ...
    def get_oauth_client(
        ...
        *,
        ...
        """
        return self._run(oauth_ops.get_oauth_client(id, client_id=client_id))
    ...
    def rotate_oauth_client_secret(self, id: str) -> OAuthClient:
        """
        ...
        """
        return self._run(oauth_ops.rotate_oauth_client_secret(id))

    # -------------------------------------------------------------------------
    # METHOD: delete_oauth_client
    # -------------------------------------------------------------------------

    def delete_oauth_client(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(oauth_ops.delete_oauth_client(id))
    ...
    def delete_webhook_subscription(self, id: str) -> bool:
        """
        ...
        Returns:
            bool: Whether the call succeeded.
        """
        return self._run(webhook_ops.delete_webhook_subscription(id))
